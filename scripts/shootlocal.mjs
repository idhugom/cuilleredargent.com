...
const shots = [
  ['/', 'live-home-desktop', 1440, 900, false],
  ['/', 'live-home-mobile', 390, 844, true],
  ['/bien-choisir-son-pack-office-windows-comparer-les-versions-pro-plus-famille-et-famille-pro.asp', 'live-article', 1440, 900, false],
...
for (const [path, name, w, h, mobile] of shots) {
  ...
  if (name === 'live-home-desktop' || name === 'live-article') {
